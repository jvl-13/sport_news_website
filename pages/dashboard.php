<?php
    ...
    $tmp = $conn->executeQuery($db, $query);
    $count = 0;
    foreach($tmp as $tp) $count++;
?>
            ...
            <div class="table-responsive">
                <table class="table align-top table-hover">
                    ...
                    <?php 
                        ...
                        {
                            $dt = date("d/m/Y", intval($document->{'published'}->__toString())/1000);
