...
<body class="m-0 p-0">
    <div  class="container-fluid m-0 p-0" >
        ...
        <div class="container-fluid align-items-center px-5 mt-4">
            <h2 class="my-3" style="font-weight: bold; font-family: var(--heading); color: var(--primary-color);">CATEGORIES</h2>

            <div>
                <!-- <button class="btn bg-warning mx-2" onclick="RefreshPage(id)" id="football">Football</button> -->
                <button class="btn bg-warning mx-2" onclick="RefreshPage(id)" id="football">Football</button>
                <button class="btn bg-warning mx-2" onclick="RefreshPage(id)" id="f1">F1</button>
                <button class="btn bg-warning mx-2" onclick="RefreshPage(id)" id="cricket">Cricket</button>
                <button class="btn bg-warning mx-2" onclick="RefreshPage(id)" id="nba">NBA</button>
                <button class="btn bg-warning mx-2" onclick="RefreshPage(id)" id="golf">Golf</button>
                <button class="btn bg-warning mx-2" onclick="RefreshPage(id)" id="boxing">Boxing</button>
                <button class="btn bg-warning mx-2" onclick="RefreshPage(id)" id="nfl">NFL</button>
                <button class="btn bg-warning mx-2" onclick="RefreshPage(id)" id="tennis">Tennis</button>
                <button class="btn bg-warning mx-2" onclick="RefreshPage(id)" id="racing">Racing</button>
                <button class="btn bg-warning mx-2" onclick="RefreshPage(id)" id="rugbyunion">Rugby Union</button>
                <button class="btn bg-warning mx-2" onclick="RefreshPage(id)" id="rugbyleague">Rugby League</button>
                <button class="btn bg-warning mx-2" onclick="RefreshPage(id)" id="darts">Darts</button>
            </div>
            ...
            <div class="row row-cols-1 row-cols-md-1 row-cols-sm-1 my-5">
                <?php
                    foreach($rows as $document){
                        ...
                        <a href="../php/content-news.php?prop_id='.$document->{'_id'}.'">
                        ...
                        <div>
                            ...
                            <p class="d-block" style="font-family: var(--heading); font-weight:300; font-size: 14px; height: 10px;">'.date("d/m/Y", intval($document->{'published'}->__toString())/1000).'<span> <img src="../assests/eye.png" style="width: 20px; height: 20px; margin-bottom: 2px;"/> '.$document->{'view'}.' views</span></p>
                            <a style="font-size: 14px; color: var(--primary-color);" href="../php/content-news.php?prop_id='.$document->{'_id'}.'">Read More<span> >></span></a>
                        </div>
                    </div>';
                    }
                ?>                
    ...
    <script type="text/javascript">
        function RefreshPage(id) {
            window.location.href = '../php/categories.php?prop_id=' + id;
        }
    </script>
</body>
</html>