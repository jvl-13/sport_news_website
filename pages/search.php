                    ...
                    foreach ($cursor as $document) {
                        echo '<div class="col-lg-4 mb-3">'.
                            ...
                            '<div>'.
                                ...
                                '<p class="d-block" style="font-family: var(--heading); font-weight:300; font-size: 14px; height: 10px;">'.date("d/m/Y", intval($document->{'published'}->__toString())/1000).'<span> <img src="../assests/eye.png" style="width: 20px; height: 20px; margin-bottom: 2px;"/>'.$document->{'view'}.'</span></p>'.
