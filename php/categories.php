...
<body class="m-0 p-0">
    <div  class="container-fluid m-0 p-0" >
        ...
        <div class="container-fluid align-items-center px-5 mt-4">
            ...
            <div>
                <button class="btn bg-warning mx-2" id="football">Football</button>
                <button class="btn bg-warning mx-2" id="f1">F1</button>
                <button class="btn bg-warning mx-2" id="cricket">Cricket</button>
                <button class="btn bg-warning mx-2" id="nba">NBA</button>
                <button class="btn bg-warning mx-2" id="golf">Golf</button>
                <button class="btn bg-warning mx-2" id="boxing">Boxing</button>
                <button class="btn bg-warning mx-2" id="nfl">NFL</button>
                <button class="btn bg-warning mx-2" id="tennis">Tennis</button>
                <button class="btn bg-warning mx-2" id="racing">Racing</button>
                <button class="btn bg-warning mx-2" id="rugbyunion">Rugby Union</button>
                <button class="btn bg-warning mx-2" id="rugbyleague">Rugby League</button>
                <button class="btn bg-warning mx-2" id="darts">Darts</button>
            </div>
